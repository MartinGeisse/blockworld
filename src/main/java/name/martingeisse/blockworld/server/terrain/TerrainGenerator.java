...
import name.martingeisse.blockworld.server.edit.ByteArrayEditAccessHost;
...
public final class TerrainGenerator {
	...
	public void generate(final AbstractSectionStorage storage, final int sectionX, final int minSectionY, final int maxSectionY, final int sectionZ) {
		...
		for (int sectionYCounter = minSectionY; sectionYCounter <= maxSectionY; sectionYCounter++) {
			...
			final byte[] compressedCubes = Cubes.createFromCubes(GeometryConstants.SECTION_CLUSTER_SIZE, cubes).compressToByteArray(GeometryConstants.SECTION_CLUSTER_SIZE);
