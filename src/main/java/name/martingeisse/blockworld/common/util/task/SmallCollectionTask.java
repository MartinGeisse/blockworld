...
public abstract class SmallCollectionTask<T> extends TaskArray {
	 ...
	 */
	public TaskLike getFollowupTask() {
		return followupTask;
	}
	 ...
	 */
	public synchronized SmallCollectionTask<T> setFollowupTask(TaskLike followupTask) {
	...
	private final class ElementTask extends Task {
		...
		public void run() {
			...
			TaskLike followupTask = SmallCollectionTask.this.followupTask;
