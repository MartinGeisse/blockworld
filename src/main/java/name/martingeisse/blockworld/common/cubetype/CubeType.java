 ...
 * 
 * TODO rename. This class partially captures the behavior of a
 * cube, but not perfectly. In the end, the "cube type index" is important
 * because it distinguishes between two cube types that have the
 * same properties. The naming "cube type" vs. "cube type index" should be
 * better -- right now it looks as if they have the same meaning.
 * 
 */
public abstract class CubeType {
	 ...
	 * 
	 * This method uses detail coordinates, with {@link GeometryConstants#GEOMETRY_DETAIL_FACTOR}
	 ...
	 * being {@link GeometryConstants#GEOMETRY_DETAIL_FACTOR}.
	 * 
	 ...
	 * (df, df, df) with df = {@link GeometryConstants#GEOMETRY_DETAIL_FACTOR} collides
