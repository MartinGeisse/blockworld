 ...
 * cluster-size units.
 */
public final class CubeArrayClusterCollider implements AxisAlignedCollider {
	...
	public boolean collides(final RectangularRegion detailCoordinateRegion) {
		...
		final RectangularRegion cubeCoordinateRegion = detailCoordinateRegion.divideAndRoundToOuter(GeometryConstants.GEOMETRY_DETAIL_CLUSTER_SIZE);
		...
		// loop over the cubes
		final int detailShift = GeometryConstants.GEOMETRY_DETAIL_SHIFT;
