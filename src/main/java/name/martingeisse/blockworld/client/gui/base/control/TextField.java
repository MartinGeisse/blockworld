...
import name.martingeisse.blockworld.client.gui.base.element.AbstractFillElement;
import name.martingeisse.blockworld.client.gui.base.element.FillColor;
import name.martingeisse.blockworld.client.gui.base.element.FocusableElement;
 ...
 * A text input field.
 */
public final class TextField extends Control implements FocusableElement {
	 ...
	 */
	private FocusableElement nextFocusableElement;
	 ...
	 */
	public FocusableElement getNextFocusableElement() {
	 ...
	 * @return this for chaining
	 */
	public TextField setNextFocusableElement(FocusableElement nextFocusableElement) {
