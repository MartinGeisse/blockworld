...
public final class Gui {
	 ...
	 * the focus
	 */
	private FocusableElement focus;
	 ...
	 * @param heightPixels the new height in pixels
	 */
	public final void resize(int widthPixels, int heightPixels) {
		this.widthPixels = widthPixels;
		this.heightPixels = heightPixels;
		this.widthUnits = pixelsToUnitsInt(widthPixels);
	 ...
	 * @return the focus
	 */
	public FocusableElement getFocus() {
		return focus;
	}
	 ...
	 */
	public void setFocus(FocusableElement focus) {
		if (focus != this.focus) {
			if (this.focus != null) {
