...
public abstract class PlayerBase {
	...
	public final RectangularRegion createCollisionRegion() {
		return createDetailCollisionRegion().divideAndRoundToOuter(new ClusterSize(GeometryConstants.GEOMETRY_DETAIL_SHIFT));
	}
	...
	private static final RectangularRegion createDetailCollisionRegion(double x, double y, double z) {
		...
		int detailX = (int)(x * GeometryConstants.GEOMETRY_DETAIL_FACTOR);
		int detailY = (int)(y * GeometryConstants.GEOMETRY_DETAIL_FACTOR);
		int detailZ = (int)(z * GeometryConstants.GEOMETRY_DETAIL_FACTOR);
