 ...
 */
public final class RenderUnit implements GlWorkUnit {
	 ...
	 */
	public void draw(final EngineParameters engineParameters, final FrameRenderParameters frameRenderParameters) {
		...
		GlWorkerLoop.getInstance().schedule(this);
