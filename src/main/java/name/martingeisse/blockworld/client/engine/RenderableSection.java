...
import name.martingeisse.blockworld.client.engine.prepare.EmptyWrapPlane;
import name.martingeisse.blockworld.client.engine.prepare.IWrapPlane;
import name.martingeisse.blockworld.client.engine.prepare.MeshBuilder;
import name.martingeisse.blockworld.client.engine.renderer.ISectionRenderer;
import name.martingeisse.blockworld.client.util.resource.SystemResourceNode;
...
public final class RenderableSection {
	...
	public void prepare(final ISectionRenderer renderer) {
		...
		renderUnits = meshBuilder.build(systemResourceNode);
							...
							if (cubeTypeCode != 255) {
								...
								if (textureIndex != 0) {
									...
									if (wrapPlane == null) {
										...
										final int neighborCubeTypeCode = cubes.getCubeRelative(nx, ny, nz) & 0xff;
