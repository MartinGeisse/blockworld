...
import name.martingeisse.blockworld.client.collision.CompositeCollider;
...
public final class WorldWorkingSet {
	 ...
	 */
	private final AxisAlignedCollider compositeCollider;
	 ...
	 */
	public AxisAlignedCollider getCompositeCollider() {
	...
	public void draw(final FrameRenderParameters frameRenderParameters) {
		...
		for (RenderUnit renderUnit : renderUnits) {
			renderUnit.draw(engineParameters, frameRenderParameters);
		}
