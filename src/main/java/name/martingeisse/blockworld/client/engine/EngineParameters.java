...
public final class EngineParameters {
	 ...
	 */
	public EngineParameters(final ISectionRenderer sectionRenderer, final Texture[] cubeTextures, final CubeType[] cubeTypes) {
	 ...
	 */
	public Texture getCubeTexture(final int cubeTextureIndex) {
